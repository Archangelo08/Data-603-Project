...
* Performing regression model diagnostic test by verfying if the model conforms with the different regression assumptions - Divine Ahuchogu
...
cat(" Given that p-value = 0.8049 which tells us that the residuals are normally distributed, we fail to reject the null hypothesis at 0.05 significant level.")
