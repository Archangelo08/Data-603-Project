...
ggplot(bestmodel, aes(x=.fitted, y=.resid)) + geom_point() + geom_smooth() + geom_hline(yintercept = 0) + labs(title = "linearity chart")
...
If we look at the RMSE, the model after Box-Cox transformation has been significantly reduced to 2.853. Similarly, the RMSE model also increased from 0.731 to 0.7323. With this information, we can conclude that this is our best model despite it not conforming with the Equal Variance Assumption.
